        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('log_path')
                    ...
                    ->setDeprecated('dennisvanbeersel/symfony-logger-client', '2.0', 'The "%node%" option is deprecated and ignored since the bundle delegates to applogger/sdk-core.')
                ...
                ->arrayNode('circuit_breaker')
                    ...
                    ->children()
                        ->booleanNode('enabled')
                            ->defaultTrue()
                            ->setDeprecated('dennisvanbeersel/symfony-logger-client', '2.0', 'The "%node%" option is deprecated and ignored since the bundle delegates to applogger/sdk-core (its circuit breaker is always-on).')
